...
public:
  ...
  void init(const mlir::SmallVector<uint32_t> &thisRepCutPartition, const std::filesystem::path &workDirectory,
            const size_t partId, mlir::DenseMap<uint32_t, mlir::SmallVector<uint32_t>> &&vectorElementsMap) {
