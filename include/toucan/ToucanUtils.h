...
void attachNameHintAndFragmentId(mlir::RewriterBase &rewriter, mlir::SmallVector<mlir::Value> &values,
...
mlir::Value
generate_reduce_tree(mlir::RewriterBase &rewritter, mlir::Location loc, llvm::SmallVector<mlir::Value> &inputs,
